...
for(let x of button){
    ...
    // The following event handler fires when a mouse button is pressed down on the Backspace element
    Backspace.onmousedown = back;
    
    // The following event handler occurs when a user releases a mouse button over the Backspace element
